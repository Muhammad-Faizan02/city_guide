...
class UpdateHotelDesc extends StatefulWidget {
  final String hid;
  final Function updateDetail;
  const UpdateHotelDesc({super.key, required this.hid, required this.updateDetail});

  @override
  State<UpdateHotelDesc> createState() => _UpdateHotelDescState();
}

class _UpdateHotelDescState extends State<UpdateHotelDesc> {
            ...
            loading ? const Text("Processing..") :  ElevatedButton.icon(
                ...
                onPressed: ()async{
                  ...
                  if (_formKey.currentState?.validate() ?? false){
                    ...
                    String det = await hotelService.updateHotelDetail(widget.hid, desc!);
