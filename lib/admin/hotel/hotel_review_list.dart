import 'package:city_guide/admin/hotel/like_hotel_comment.dart';
import 'package:city_guide/services/hotel_service.dart';
import '../../models/user.dart';
import 'package:flutter/material.dart';

class HotelReviewList extends StatefulWidget {
  final String hId;
  const HotelReviewList({super.key, required this.hId});

  @override
  State<HotelReviewList> createState() => _HotelReviewListState();
}

class _HotelReviewListState extends State<HotelReviewList> {
  ...
  Widget build(BuildContext context) {
              ...
              child: ListTile(
                ...
                trailing: Row(
                  ...
                  children: [
                    ...
                    LikeHotelComment(hid: widget.hId, index: index),
                    Text("${comment.likes}")
                  ],
                ),
              ),
    ...
    Future<void> _deleteComment(int index) async {
      try {
        await hotelService.deleteCommentByIndex(widget.hId, index);
      } catch (e) {
