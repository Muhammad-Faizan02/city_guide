...
class HotelRatingView extends StatefulWidget {
  final String hId;
  const HotelRatingView({
    super.key,
    required this.hId
  });

  @override
  State<HotelRatingView> createState() => _HotelRatingViewState();
}

class _HotelRatingViewState extends State<HotelRatingView> {
  HotelService hotelService = HotelService();

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<List<Ratings>>(
      stream: hotelService.ratingsStreamByHotelId(widget.hId),
