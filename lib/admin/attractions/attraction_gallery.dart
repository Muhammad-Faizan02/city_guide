...
class AttractionGallery extends StatefulWidget {
  final String id;
  final String name;
  const AttractionGallery({super.key, required this.id, required this.name});

  @override
  State<AttractionGallery> createState() => _AttractionGalleryState();
}

class _AttractionGalleryState extends State<AttractionGallery> {
                    ...
                    Positioned(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          attractionService.deleteImageFromAttraction(widget.id, images[index]);
