...
class AddAttractionImage extends StatefulWidget {
  final String id;
  const AddAttractionImage({super.key, required this.id});

  @override
  State<AddAttractionImage> createState() => _AddAttractionImageState();
}

class _AddAttractionImageState extends State<AddAttractionImage> {
  String? _imageUrl;
  File? _pickedImage;
  bool loading = false;
            ...
            _pickedImage != null ? loading ?    const Center
              ...
              valueColor: AlwaysStoppedAnimation<Color>(Colors.black),
                ...
                onPressed: ()async{
                  ...
                  await attractionService.addImage(widget.id, _imageUrl!);
                  if(mounted){
