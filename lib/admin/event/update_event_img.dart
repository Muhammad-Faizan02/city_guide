...
class UpdateEventImg extends StatefulWidget {
  final String eid;
  final String img;
  ...
  @override
  State<UpdateEventImg> createState() => _UpdateEventImgState();
}

class _UpdateEventImgState extends State<UpdateEventImg> {
  String? _imageUrl;
  File? _pickedImage;
  bool loading = false;
            ...
            const Center
              ...
              valueColor: AlwaysStoppedAnimation<Color>(Colors.black),
                ...
                onPressed: ()async{
                  ...
                  _imageUrl =  await eventService.updateEventImg(widget.eid, widget.img, _pickedImage!);
