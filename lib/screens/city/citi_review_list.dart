import 'package:city_guide/screens/city/like_citi_comments.dart';
import 'package:flutter/material.dart';
import '../../services/city_service.dart';
import '../../models/user.dart';
class CitiReviewList extends StatefulWidget {
  final String cid;
  final String id;
  const CitiReviewList({super.key, required this.cid, required this.id});

  @override
  State<CitiReviewList> createState() => _CitiReviewListState();
}
class _CitiReviewListState extends State<CitiReviewList> {
            ...
            return Card(
              child: ListTile(
                ...
                trailing: Row(
                  ...
                  children: [
                    LikeCitiComment(cid: widget.cid, index: index, comment: comment, id: widget.id,),
                    Text("${comment.likes}")
                  ],
                ),
              ),
